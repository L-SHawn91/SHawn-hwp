...
<!-- BEGIN shawn-common-rules (GENERATED by SHawn-sync/tools/project_agents_common_block.py — do not hand-edit; regenerate with --apply) -->
...
<!-- END shawn-common-rules -->

<!-- BEGIN shawn-common-verification (GENERATED by SHawn-sync/tools/project_agents_common_block.py — do not hand-edit; regenerate with --apply) -->
