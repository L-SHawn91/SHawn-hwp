...
1. Add profile-vs-generated post-generation QA.
2. Add non-marker slot detection for common official HWPX table forms.
3. Add package builder: originals, generated HWPX/DOCX/PDF, validation report, QA report.
4. Add real official-template fixture validation once user-approved samples are selected.
